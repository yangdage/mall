...
func (s *Statistics) WebGetStatisticsInfo(id uint) models.WebStatisticsInfo {
	var info models.WebStatisticsInfo
...
func (s *Statistics) WebGetTodayOrderInfo(id uint) models.WebTodayOrderInfo {
	var toi models.WebTodayOrderInfo
...
// WebGetWeekInfo 获取本周订单总览信息
func (s *Statistics) WebGetWeekInfo(id uint) models.WebWeekOrderInfo {
...
func weekInfo(id uint, days int) models.WebWeekOrderInfo {
	var woi models.WebWeekOrderInfo
